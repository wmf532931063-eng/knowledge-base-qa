...
import { Send, Loader2, Bot, User, ScrollText, Sparkles, BookOpen } from 'lucide-react'
...
export default function FortuneChat({ backendConfig, documents }: FortuneChatProps) {
