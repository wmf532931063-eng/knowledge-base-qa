...
import { Send, Loader2, Bot, User, FileText, Trash2, PlusCircle } from 'lucide-react'
import { Message } from '@/lib/types'
import CustomConfirmDialog from './CustomConfirmDialog'
import { useConfirmDialog } from '@/lib/hooks/useConfirmDialog'

interface ChatInterfaceWithDialogProps {
  apiKey: string
}

export default function ChatInterfaceWithDialog({ apiKey }: ChatInterfaceWithDialogProps) {
